 ...
 *
 * 	#import <SDWebImage/UIImageView+NAMO_WebCache.h>
 * 	
 * 	...
 * 	
 ...
 * 	    }
 * 	
 * 	    // Here we use the provided namo_setImageWithURL: method to load the web image
 ...
 * 	
 */
@interface UIImageView (NAMO_WebCache)
 ...
 */
- (void)namo_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder;
 ...
 */
- (void)namo_setImageWithURL:(NSURL *)url completed:(NAMO_SDWebImageCompletedBlock)completedBlock;
