...
/**
 ...
 <img style="border:2px dotted black" alt="Preview" src="http://docs.namomedia.com/images/ad-format-sample-4.png">
 ...
 */
@interface NAMOAdFormatSample4 : UIView<NAMOAdFormat>
