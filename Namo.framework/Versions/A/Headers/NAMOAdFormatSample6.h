...
/**
 ...
 <img style="border:2px dotted black" alt="Preview" src="http://docs.namomedia.com/images/ad-format-sample-6.png">
...
*/
@interface NAMOAdFormatSample6 : UIView<NAMOAdFormat>
@end
